...
export class WorkflowApi extends runtime.BaseAPI {
     ...
     */
    async streamWorkflowRaw(requestParameters: StreamWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobStreamEvent>> {
     ...
     * Streams the workflow output for the given workflow ID
     */
    async streamWorkflow(requestParameters: StreamWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JobStreamEvent> {
